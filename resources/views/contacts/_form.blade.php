<div class="row">
    <div class="col-md-12">
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input type="text" value="{{ old('first_name', $contact->first_name) }}" name="first_name" id="first_name"
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <input type="text" value="{{ old('last_name', $contact->last_name) }} " name="last_name" id="last_name"
            ...
            <div class="col-md-9">
                <select name="company_id" id="company_id"
                    ...
                    @foreach ($companies as $id => $name)
                        <option @selected (old('company_id', $contact->company_id) == $id) value="{{ $id }}">{{ $name }}</option>
                    @endforeach
                </select>
                @error('company_id')
                    <div class="invalid-feedback">{{ $message }}</div>
